...
@section('meta_url', route('udemy_gratis', ['rutafree' => $courses_free_detalle->published_title]))
            ...
            <div class="">
                <div class=" max-w-5xl px-10 py-6 bg-white rounded-lg shadow-md">
                    <div class="mx-auto flex flex-wrap">
                        ...
                        <div class="mt-2">
                            <a href="/cursos-gratis" class="text-5xl text-gray-700 font-bold hover:underline">{{ $courses_free_detalle->title }}</a>
                                ...
                                <h1 class="text-gray-900 title-font font-medium text-3xl my-4 font-bold mb-1">Descripción</h1>
