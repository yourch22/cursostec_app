    ...
    <div class="mb-4 md:mb-0 w-full max-w-screen-md mx-auto relative">
        <h2 class="my-6 text-lg lg:text-xl font-bold"><strong>Política de Cookies</strong></h2>
         <p> En esta web se utilizan cookies de terceros y propias para conseguir que tengas una mejor experiencia de navegación, puedas compartir contenido en redes sociales y para que podamos obtener estadísticas de los usuarios.<br><br>
            ...
            <p class="ng-binding">La entidad responsable de la recogida, procesamiento y utilización de tus datos personales, en el sentido establecido por la Ley de Protección de Datos Personales es la página  <a class="font-semibold underline text-blue-800" href="/" >https://cursostec.com </a>, propiedad de cursostec – lima.</p>
                        ...
                        <p>Las cookies utilizadas en nuestro sitio web, son de sesión y de terceros, y nos permiten almacenar y acceder a información relativa al idioma, el tipo de navegador utilizado, y otras características generales predefinidas por el usuario, así como, seguir y analizar la actividad que lleva a cabo, con el objeto de introducir mejoras y prestar nuestros servicios de una manera más eficiente y personalizada. <br><br>
                          ...
                          cursostec) o bien cuando se borran manualmente. </p>  
            <p></p>
            ...
            <p class="ng-binding">Importante: Salvo que el usuario decida registrarse en un servicio de
              cursostec, la cookie nunca irá asociada a ningún dato de carácter personal que pueda identificarle. Dichas cookies sólo serán utilizadas con propósitos estadísticos que ayuden a la optimización de la experiencia de los usuarios en el sitio.</p>
