<div class="w-full mb-6 mx-auto px-4 flex items-center justify-between">
<h2>
  <span class="text-2xl">
    {{__('Los mejores cursos de')}}
    <strong class="text-2xl">{{ __($categoria_home[0]['categoria']) }} Gratis</strong>
  </span>
</h2>
    <div class="flex items-center select-none invisible sm:invisible md:visible lg:visible xl:visible">
        <a href="" class="ml-2 flex items-center border
          py-2 px-3 leading-none text-white bg-blue-850 hover:bg-blue-750 rounded-md p-2 focus:outline-none">
        ...
        <div class="p-4 border-t border-b">
          <div class="grid grid-cols-2">
              <div class="col-span-2 text-center">
                ...
                <button type="submit" class="bg-blue-850 text-sm hover:bg-blue-750 text-white font-bold py-2 px-6 rounded-full inline-flex items-center">
