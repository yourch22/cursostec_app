...
@section('_title', '⭐ '.$itemsubcatDet->subcategoria.':')  
@section('meta_title', 'Los mejores cursos de '.$itemsubcatDet->subcategoria)
...
<div class="w-screen sm:w-full md:full lg:w-full xl:w-full mx-auto grid grid-cols-1 px-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 mb-10">
  ...
  <div class="c-card block bg-white shadow-md hover:shadow-xl rounded-lg overflow-hidden">
    {{-- <a href="{{ config('services.cred_affiliate_admitad.url') . '' . config('services.cred_affiliate_admitad.sub_id') . config('services.cred_affiliate_admitad.url_udemy') . $item->url }}" target="_blank" > --}}
      ...
      <div class="p-4 border-t border-b">
        <div class="grid grid-cols-2">
          <div class="col-span-2 text-center">
            ...
            @else
            <button href="https://www.udemy.com{{$item->url}}" target="_blank" class="bg-blue-850 text-sm hover:bg-blue-750 text-white font-bold py-2 px-6 rounded-full inline-flex items-center">
